...
const Footer = () => {
  return (
    <footer className="bg-gray-800 bg-opacity-85 px-4 py-5 max-w-screen-xl mx-auto md:px-8" style={{ maxWidth: '100%' }}>
      <ul className="flex items-center justify-center mt-8 space-x-4 sm:space-x-4">
          <a href="https://github.com/nemethzozzi" className="hover:text-white hover:scale-110 transition-transform">
            <svg className="svg-icon w-6 h-6 hover:fill-current" fill="#9ca3af" viewBox="0 0 16 16">
          ...
          <a href="https://twitter.com/nemeth_zozzi" className="hover:text-white hover:scale-110 transition-transform">
            <svg className="svg-icon w-6 h-6 hover:fill-current" fill="#9ca3af" viewBox="0 0 24 24">
          ...
          <a href="mailto:nemethzoltan0524@gmail.com" className="hover:text-white hover:scale-110 transition-transform">
          <svg className="svg-icon w-6 h-6 hover:fill-current" fill="#9ca3af" viewBox="0 0 22 22">
          ...
          <a href="https://www.linkedin.com/in/zoltán-németh-15532928a/" className="hover:text-white hover:scale-110 transition-transform">
            <svg className="svg-icon w-6 h-6 hover:fill-current" fill="#9ca3af" viewBox="0 0 16 16">
          ...
          <a href="https://discordapp.com/users/654333734580912148" className="hover:text-white hover:scale-110 transition-transform">
            <svg className="svg-icon w-6 h-6 hover:fill-current" fill="#9ca3af" viewBox="0 0 16 16">
